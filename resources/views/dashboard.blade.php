                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="avatar" src="{{ asset('template/img/user.jpg') }}" alt="User Avatar">
                                </a>
                                ...
                                <div class="list-item-wrap">
                                    <div class="list-item">
                                        <div class="item-inner">
                                            ...
                                            <div class="list-title"><a href="javascript:void(0)">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a></div>
