            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body chat-box scrollable" style="height:300px;">
                        <ul class="chat-list">
                            <li class="chat-item">
                                <div class="chat-img"><img src="{{ asset('img/users/1.jpg') }}"
                                        alt="user"></div>
                            ...
                            <li class="chat-item">
                                <div class="chat-img"><img src="{{ asset('img/users/2.jpg') }}"
                                        alt="user"></div>
                                <div class="chat-content">
                            ...
                            <li class="chat-item">
                                <div class="chat-img"><img src="{{ asset('img/users/3.jpg') }}"
                                        alt="user"></div>
                                <div class="chat-content">
                ...
                <div class="card" style="min-height: 422px;">
                    ...
                    <div class="card-body timeline">
                        <div class="header bg-theme"
                            style="background-image: url('{{ asset('img/placeholder/placeimg_400_200_nature.jpg') }}')">
            ...
            <div class="card-header row">
                <div class="col col-sm-3">
                    <div class="dropdown d-inline-block">
                        <a class="btn-icon checkbox-dropdown dropdown-toggle" href="#"
                    ...
                    <div class="card-options d-inline-block">
                        ...
                        <div class="dropdown d-inline-block">
                            <a class="nav-link dropdown-toggle" href="#" id="moreDropdown"
                                ...
                                aria-expanded="false"><i class="ik ik-more-horizontal"></i></a>
